...
def rand_uniform(bound, size=None):
    """
    generate size data structure based on bound
    """
...
def random_crop(arr, N): 
    """
    cut a subarray from array, which has an exact length of N.
    """ 
...
class Augmenter(object):
    """
    wrapper for a serials of transformations
    """
    ...
    class SimpleNoise(object):
        """
        add simple noise to audio, noice is generate based intensity
        """
    ...
    class PlaySpeed(object):
        """
        adjust speed audio by a rate (e.g., longer or shorter)
        """
    ...
    class Amplify(object):
        """
        adjust audio by a rate (e.g., louder or lower)
        """
